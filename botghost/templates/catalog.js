...
const PLACEHOLDERS = {
  ...
  'resultado.nota': { help: 'Nota efetiva (ajustada, se houver)', sample: '86' },
...
const TEMPLATES = {
  ...
  room_created: {
    ...
    placeholders: [...BASE, ...STUDENT, 'prova.duracao', 'sala.nome', 'sala.codigo', 'links.aluno', 'links.fiscal'],
    pingTargets: [],
    default: {
      content: '',
      embed: embed({
        ...
        fields: [
          ...
          { name: '👁️ Link do FISCAL (é seu — não envie ao aluno)', value: '[[links.fiscal]]', inline: false },
        ],
        footerText: 'Copie agora: os links não podem ser mostrados de novo. Se perder, use Regenerar links.',
      }),
      pings: NO_PINGS,
    },
  },
  ...
  result_updated: {
    label: 'Resultado alterado (edição da mensagem)',
    visibility: 'public',
    help: 'Usado para EDITAR a mensagem original quando o admin ajusta a nota. Edições nunca notificam ninguém.',
    placeholders: ['data', ...STUDENT, ...RESULT, 'resultado.notaOriginal'],
    pingTargets: [],
    default: {
      content: 'Prova finalizada: [[aluno.mencao]] — Nota: [[resultado.nota]] / [[resultado.total]] — Prova: [[prova.nome]]\n-# Nota ajustada pelo admin (calculada pelo site: [[resultado.notaOriginal]])',
      embed: NO_EMBED,
      pings: NO_PINGS,
    },
  },
