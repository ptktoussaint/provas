...
| `[[resultado.cargoMencao]]` | Menção do cargo de aprovado da prova (vazio se não aprovado) | <@&300000000000000007> |
| `[[resultado.gabaritou]]` | Sim / Não — tirou a nota máxima (decidido pelo site) | Não |
