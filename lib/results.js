...
async function listForDiscord({ guildId, userId = null, examId = null, from = null, to = null, sort = 'date-desc', page = 0, pageSize = 8 }) {
  const match = { deletedAt: null, archivedAt: null, status: { $in: FINISHED_STATUSES } };
  if (userId) {
